...
func appendParams(params met.MSFragger) *exec.Cmd {
	...
	args := exec.Command("java",
		...
		fmt.Sprintf("%d", params.UseAllModsInFirstSearch),
		...
		params.SearchEnzymeName1,
		"--search_enzyme_cut_1",
		params.SearchEnzymeCut1,
		"--search_enzyme_nocut_1",
		params.SearchEnzymeNocut1,
		"--allowed_missed_cleavage_1",
		fmt.Sprintf("%d", params.AllowedMissedCleavage1),
		"--search_enzyme_sense_1",
		params.SearchEnzymeSense1,
		"--search_enzyme_name_2",
		params.SearchEnzymeName2,
		"--search_enzyme_cut_2",
		params.SearchEnzymeCut2,
		"--search_enzyme_nocut_2",
		params.SearchEnzymeNocut2,
		"--allowed_missed_cleavage_2",
		fmt.Sprintf("%d", params.AllowedMissedCleavage2),
		"--search_enzyme_sense_2",
		params.SearchEnzymeSense2,
		"--num_enzyme_termini",
		...
		"--check_spectral_files",
		fmt.Sprintf("%d", params.CheckSpectralFiles),
		"--minimum_peaks",
