...
//
// 	if err != nil {
// 		fmt.Println("[ERROR]: Cannot open ProtXML file:", f)
// 		os.Exit(1)
// 	}
// 	defer xmlfile.Close()
//
...
//
// 			if inElement == "protein_group" {
//
// 				var ptg pro.ProteinGroup
// 				decoder.DecodeElement(&ptg, &se)
//
// 				var gi GroupIdentification
// 				var proteinList ProtIDList
//
// 				gi.GroupNumber = ptg.GroupNumber
// 				gi.Probability = ptg.Probability
//
// 				for jindex, j := range ptg.Protein {
//
// 					// correcting group probabilities
// 					if jindex == 0 {
// 						if ptg.Probability == 1 && j.Probability == 0 {
// 							j.Probability = float64(ptg.Probability)
// 						}
// 					}
//
// 					var ptid ProteinIdentification
//
// 					ptid.GroupNumber = ptg.GroupNumber
// 					ptid.Probability = ptg.Probability
// 					ptid.ProteinName = string(j.ProteinName)
// 					ptid.Probability = j.Probability
// 					ptid.PercentCoverage = j.PercentCoverage
// 					ptid.PctSpectrumIDs = j.PctSpectrumIDs
// 					ptid.Confidence = j.Confidence
// 					ptid.TopPepProb = j.Peptide[0].InitialProbability
// 					ptid.GroupSiblingID = string(j.GroupSiblingID)
//
// 					if strings.EqualFold(string(j.Parameter.Name), "prot_length") {
...
//
// 				gi.Proteins = proteinList
// 				groupList = append(groupList, gi)
//
// 				ptg = pro.ProteinGroup{}
// 				se = xml.StartElement{}
// 			}
//
// 		default:
...
//
// 	if len(groupList) == 0 {
// 		logrus.Fatal("No Protein groups detected, check your file and try again")
// 	}
//
// 	return nil
// }
