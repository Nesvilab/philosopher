...
func init() {
	...
	if len(os.Args) > 1 && os.Args[1] == "peptideprophet" {
		...
		filterCmd.Flags().MarkHidden("exclude")
		filterCmd.Flags().MarkHidden("forcedistr")
		filterCmd.Flags().MarkHidden("icat")
		filterCmd.Flags().MarkHidden("instrwarn")
		filterCmd.Flags().MarkHidden("leave")
		filterCmd.Flags().MarkHidden("maldi")
		filterCmd.Flags().MarkHidden("minpintt")
		filterCmd.Flags().MarkHidden("minpiprob")
		filterCmd.Flags().MarkHidden("minrtntt")
		filterCmd.Flags().MarkHidden("minrtprob")
		filterCmd.Flags().MarkHidden("neggamma")
		filterCmd.Flags().MarkHidden("noicat")
		filterCmd.Flags().MarkHidden("optimizefval")
		filterCmd.Flags().MarkHidden("pi")
		filterCmd.Flags().MarkHidden("zero")
