...
func init() {
	...
	if len(os.Args) > 1 && os.Args[1] == "msfragger" {
		...
		msfraggerCmd.Flags().IntVarP(&m.MSFragger.FragmentMassTolerance, "fragment_mass_tolerance", "", 20, "")
		...
		msfraggerCmd.Flags().IntVarP(&m.MSFragger.IsotopeError, "isotope_error", "", 0, "0=off, -1/0/1/2/3 (standard C13 error)")
		...
		msfraggerCmd.Flags().IntVarP(&m.MSFragger.ShiftedIons, "shifted_ions", "", 0, "")
		msfraggerCmd.Flags().StringVarP(&m.MSFragger.ShiftedIonsExcludeRanges, "shifted_ions_exclude_ranges", "", "(-1.5,3.5)", "")
		...
		msfraggerCmd.Flags().StringVarP(&m.MSFragger.SearchEnzymeCutafter, "search_enzyme_cutafter", "", "Trypsin", "")
		...
		msfraggerCmd.Flags().StringVarP(&m.MSFragger.VariableMod01, "variable_mod_01", "", "15.99490_M", "")
		msfraggerCmd.Flags().StringVarP(&m.MSFragger.VariableMod02, "variable_mod_02", "", "42.01060_[^", "")
		...
		msfraggerCmd.Flags().Float64VarP(&m.MSFragger.AddNtermPoteine, "add_Nterm_protein", "", 0.000000, "")
